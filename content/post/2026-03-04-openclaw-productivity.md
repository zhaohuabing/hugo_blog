...
先简单介绍一下 OpenClaw：它是一个开源、自托管的 AI Agent Gateway。你可以把它理解为“消息渠道”和“AI 执行能力”之间的统一中枢：一边连 Telegram、WhatsApp（我最常用的两个入口），另一边连模型、工具、会话和记忆系统。
...
为了证明这篇文章确实是“通过聊天协作”完成的，我把刚才对话中的截图也放在这里：
...
<center><img src="/img/2026-03-04-openclaw-productivity/chat-proof-3.jpg" alt="通过聊天协作写作截图 3"/></center>
