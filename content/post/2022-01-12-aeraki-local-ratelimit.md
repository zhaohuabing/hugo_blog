...
title:      "Aeraki 教程系列：如何设置本地限流规则？"
subtitle:   ""
description: "Aeraki 的限流规则设计直观而灵活，既支持对一个服务的所有入向请求进行限流，也支持按照不同的条件对一个服务器的请求进行细粒度的限流控制。"
author: "赵化冰"
date: 2022-01-12
image: "https://images.unsplash.com/photo-1603803648693-d0659d886b13?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
tags:
    - Aeraki
    - MetaProtocol
    - Istio
