...
### vibe coding
我觉得 Claude Code， Cursor 等厂商宣传的「一次跑十几个 Agent，全自动写出一个系统」的炫酷操作，对真实工程场景来说还不太现实。一是这种操作将消耗大量 Token，对于普通用户来说不现实，二是在 Code Agent 的工作流中，**人机协作**其实非常重要。这两天 [Cursor 号称使用 AI 写出了一个浏览器，但被网友扒出连编译都无法通过的事情](https://www.reddit.com/r/programming/comments/1qdo9r3/cursor_ceo_built_a_browser_using_ai_but_does_it/)，也说明了这些很大程度上是宣传噱头。
