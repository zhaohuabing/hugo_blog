...
## 总结
Envoy Gateway 1.1 版本引入了多个新特性和改进，包括 Wasm 扩展的 OCI 镜像支持，External Process 扩展，非 K8s 服务的直接支持，IP 黑白名单，会话保持，自定义 Filter 顺序等。这些新特性和改进使得 EG 在更多的场景下可以发挥作用，为用户提供了更多的灵活性和可定制性。我们鼓励用户尽快升级到 1.1 版本，以便享受到这些新特性带来的好处。
